<template>
    <div>
                ...
                <div class="addr-list">
                  <ul>
                    <li v-for="(item,index) in addressListFilter" :class="{'check':checkIndex===index}" @click="checkIndex=index;selectAddrId=item.addressId;">
                      ...
                      <div @click="delAddressConfirm(item)" class="addr-opration addr-del">
                        <a href="javascript:;" class="addr-del-btn">
                          <svg class="icon icon-del"><use xlink:href="#icon-del"></use></svg>
                        </a>
                      </div>
                      <div class="addr-opration addr-set-default">
                        <a @click="setDefault(item.addressId)" v-if="!item.isDefault" href="javascript:;" class="addr-set-default-btn"><i>Set default</i></a>
                      </div>
        ...
        <modal :mdShow="isMdShow" @close="closeModal">
          ...
          <div slot="btnGroup">
            <a @click="delAddress" href="javascript:void(0)" class="btn btn--m">确认</a>
            <a @click="isMdShow = false" href="javascript:void(0)" class="btn btn--m">取消</a>
          </div>
        </modal>
